...
init_config_file = "config/social_navigation/leading_human/robot.lua"
...
human_config_list = {"config/social_navigation/leading_human/human_follower.lua"}
door_config_list = {"config/social_navigation/leading_human/door.lua"}
