...
init_config_file = "config/social_navigation/navigating_crowd/robot.lua"
...
human_config_list = {
  "config/social_navigation/navigating_crowd/humans/human1.lua",
  "config/social_navigation/navigating_crowd/humans/human2.lua",
  "config/social_navigation/navigating_crowd/humans/human3.lua",
  "config/social_navigation/navigating_crowd/humans/human4.lua",
  "config/social_navigation/navigating_crowd/humans/human5.lua",
  "config/social_navigation/navigating_crowd/humans/human6.lua",
  "config/social_navigation/navigating_crowd/humans/human7.lua",
}
