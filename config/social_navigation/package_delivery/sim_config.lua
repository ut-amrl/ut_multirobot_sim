...
init_config_file = "config/social_navigation/package_delivery/robot.lua"
...
human_config_list = {
  "config/social_navigation/package_delivery/humans/human1.lua",
  "config/social_navigation/package_delivery/humans/human2.lua",
  "config/social_navigation/package_delivery/humans/human3.lua",
  "config/social_navigation/package_delivery/humans/human4.lua",
  "config/social_navigation/package_delivery/humans/human5.lua",
  "config/social_navigation/package_delivery/humans/human6.lua",
}
...
--robot_config = "config/social_navigation/package_delivery/ut_automata_config.lua"
