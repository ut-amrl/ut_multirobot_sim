...
init_config_file = "config/social_navigation/blind_corner/robot.lua"
...
human_config_list = {
  "config/social_navigation/blind_corner/humans/human1.lua",
  "config/social_navigation/blind_corner/humans/human2.lua",
  "config/social_navigation/blind_corner/humans/human3.lua",
  "config/social_navigation/blind_corner/humans/human4.lua",
  "config/social_navigation/blind_corner/humans/human5.lua",
  "config/social_navigation/blind_corner/humans/human6.lua",
}
